...
| `ErrorState` | apps/memberry | component | 2 | — | MEDIUM |
| `useAdminUser` | apps/admin | hook | 0 | — | MEDIUM |
| `RequireRole` | apps/admin | component | 2 | — | MEDIUM |
| `RootComponent` | apps/memberry | component | 0 | — | MEDIUM |
| `DashboardPage` | apps/memberry | component | 0 | ✅ | MEDIUM |
| `Combobox` | apps/memberry | component | 0 | — | MEDIUM |
| `ImageCropperDialog` | apps/memberry | component | 6 | — | MEDIUM |
| `NotificationDrawer` | apps/memberry | component | 2 | ✅ | MEDIUM |
| `useDetectCountry` | apps/memberry | hook | 0 | — | MEDIUM |
| `useDetectLanguage` | apps/memberry | hook | 0 | — | MEDIUM |
| `useDetectTimezone` | apps/memberry | hook | 0 | — | MEDIUM |
| `useFormatDate` | apps/memberry | hook | 0 | — | MEDIUM |
| `useMutationFeedback` | apps/memberry | hook | 0 | — | MEDIUM |
| `useFinancialStanding` | apps/memberry | hook | 0 | — | MEDIUM |
| `useMyOrgs` | apps/memberry | hook | 0 | — | MEDIUM |
| `useOrg` | apps/memberry | hook | 0 | — | MEDIUM |
| `useOrgContext` | apps/memberry | hook | 0 | — | MEDIUM |
| `OrgProvider` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `useOrgProvider` | apps/memberry | hook | 0 | — | MEDIUM |
| `useOrgProviderOptional` | apps/memberry | hook | 0 | — | MEDIUM |
| `AuthenticatedLayout` | apps/memberry | component | 0 | — | MEDIUM |
| `JoinPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `OnboardingPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `VerifyEmailPage` | apps/memberry | component | 0 | — | MEDIUM |
| `useFileUpload` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useAuthClient` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `ApiProvider` | packages/sdk-ts | component | 5 | — | MEDIUM |
...
| `CommunicationsBroadcasts` | apps/admin | component | 0 | — | MEDIUM |
| `ModerationQueue` | apps/admin | component | 0 | — | MEDIUM |
| `PlatformTemplates` | apps/admin | component | 0 | — | MEDIUM |
| `CompliancePage` | apps/admin | component | 0 | — | MEDIUM |
| `MemberDetailPage` | apps/memberry | component | 0 | — | MEDIUM |
| `MembersPage` | apps/admin | component | 0 | ✅ paired | MEDIUM |
| `OrganizationDetailPage` | apps/admin | component | 0 | ✅ paired | MEDIUM |
| `OrganizationsPage` | apps/admin | component | 0 | ✅ paired | MEDIUM |
| `VerificationsPage` | apps/admin | component | 0 | — | MEDIUM |
| `MemberBottomNav` | apps/memberry | component | 0 | — | MEDIUM |
| `MemberHeader` | apps/memberry | component | 1 | — | MEDIUM |
| `MemberSidebar` | apps/memberry | component | 2 | — | MEDIUM |
| `OfficerMobileNav` | apps/memberry | component | 4 | — | MEDIUM |
| `OfficerSidebar` | apps/memberry | component | 5 | — | MEDIUM |
| `OrgIconRail` | apps/memberry | component | 1 | — | MEDIUM |
| `OrgPickerSheet` | apps/memberry | component | 5 | — | MEDIUM |
| `CountUp` | apps/memberry | component | 6 | — | MEDIUM |
| `GlassCard` | apps/memberry | component | 2 | — | MEDIUM |
| `StaggerGrid` | apps/memberry | component | 3 | — | MEDIUM |
| `StaggerItem` | apps/memberry | component | 2 | — | MEDIUM |
| `useSpringTransition` | apps/memberry | hook | 0 | — | MEDIUM |
| `AvatarInitials` | apps/memberry | component | 4 | — | MEDIUM |
| `ConfirmDialog` | apps/memberry | component | 9 | — | MEDIUM |
| `DataTable` | apps/memberry | component | 4 | — | MEDIUM |
| `DatePicker` | apps/memberry | component | 5 | — | MEDIUM |
| `DateTimePicker` | apps/memberry | component | 5 | — | MEDIUM |
| `DateRangePicker` | apps/memberry | component | 5 | — | MEDIUM |
| `EmptyState` | apps/memberry | component | 4 | — | MEDIUM |
| `PageHeader` | apps/memberry | component | 4 | — | MEDIUM |
...
| `InvitePage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `PublicOrgProfile` | apps/memberry | component | 0 | ✅ | MEDIUM |
| `PublicPaymentPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `VerifyCertificatePage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `VerifyCredentialPage` | apps/memberry | component | 0 | ✅ | MEDIUM |
| `PublicVerification` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `useSession` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `usePrefetchSession` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useToken` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useListAccounts` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useListSessions` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useListDeviceSessions` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useListPasskeys` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useUpdateUser` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useUnlinkAccount` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useRevokeOtherSessions` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useRevokeSession` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useRevokeSessions` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useSetActiveSession` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useRevokeDeviceSession` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useDeletePasskey` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useAuthQuery` | packages/sdk-ts | hook | 0 | — | MEDIUM |
| `useAuthMutation` | packages/sdk-ts | hook | 0 | — | MEDIUM |
...
| `BookingList` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `BookingWidgetSkeleton` | apps/memberry | component | 1 | — | MEDIUM |
| `TimeSlotsSkeleton` | apps/memberry | component | 0 | — | MEDIUM |
...
| `ChatThread` | apps/memberry | component | 2 | ✅ paired | MEDIUM |
| `ChatView` | apps/memberry | component | 3 | ✅ paired | MEDIUM |
| `ConnectionStatus` | apps/memberry | component | 2 | — | MEDIUM |
| `CreateChannelDialog` | apps/memberry | component | 3 | ✅ | MEDIUM |
| `DmList` | apps/memberry | component | 4 | ✅ paired | MEDIUM |
| `MessageBubble` | apps/memberry | component | 6 | — | MEDIUM |
| `MessageComposer` | apps/memberry | component | 3 | ✅ paired | MEDIUM |
| `MessageReactions` | apps/memberry | component | 3 | — | MEDIUM |
| `MessageSearch` | apps/memberry | component | 3 | ✅ paired | MEDIUM |
| `ThreadPanel` | apps/memberry | component | 4 | ✅ paired | MEDIUM |
| `TypingIndicator` | apps/memberry | component | 1 | — | MEDIUM |
| `VideoCallPanel` | apps/memberry | component | 4 | — | MEDIUM |
| `VideoCallUI` | apps/memberry | component | 14 | — | MEDIUM |
| `VideoGrid` | apps/memberry | component | 12 | — | MEDIUM |
| `VideoLobby` | apps/memberry | component | 4 | — | MEDIUM |
| `VideoTile` | apps/memberry | component | 4 | — | MEDIUM |
| `useChatWebSocket` | apps/memberry | hook | 0 | — | MEDIUM |
| `useMediaStream` | apps/memberry | hook | 0 | — | MEDIUM |
...
| `CreditRing` | apps/memberry | component | 3 | — | MEDIUM |
| `AlertBanner` | apps/memberry | component | 5 | — | MEDIUM |
| `CreditBreakdown` | apps/memberry | component | 3 | — | MEDIUM |
| `MemberDashboard` | apps/memberry | component | 0 | ✅ | MEDIUM |
| `OrgAnnouncements` | apps/memberry | component | 3 | — | MEDIUM |
| `QuickActions` | apps/memberry | component | 2 | — | MEDIUM |
| `DirectoryFilters` | apps/memberry | component | 4 | — | MEDIUM |
| `DirectorySearch` | apps/memberry | component | 2 | ✅ paired | MEDIUM |
| `MemberProfile` | apps/memberry | component | 3 | ✅ | MEDIUM |
| `TrustCard` | apps/memberry | component | 2 | — | MEDIUM |
| `TrustDirectory` | apps/memberry | component | 2 | ✅ paired | MEDIUM |
| `DocumentBrowser` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `DocumentLibrary` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `ArrearsBreakdown` | apps/memberry | component | 3 | — | MEDIUM |
...
| `DuesStatusBadge` | apps/memberry | component | 2 | — | MEDIUM |
| `DuesStatusCard` | apps/memberry | component | 6 | — | MEDIUM |
...
| `EventForm` | apps/memberry | component | 4 | ✅ | MEDIUM |
| `EventList` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `EventTimeline` | apps/memberry | component | 3 | — | MEDIUM |
| `PostEventActions` | apps/memberry | component | 5 | ✅ | MEDIUM |
| `ApplicationList` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `CategoryEditor` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
...
| `NotificationInbox` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `AddressForm` | apps/memberry | component | 8 | — | MEDIUM |
| `ContactInfoForm` | apps/memberry | component | 10 | — | MEDIUM |
| `PersonalInfoForm` | apps/memberry | component | 11 | — | MEDIUM |
| `PreferencesForm` | apps/memberry | component | 5 | — | MEDIUM |
| `StandingMeter` | apps/memberry | component | 3 | — | MEDIUM |
| `TrustBadges` | apps/memberry | component | 1 | — | MEDIUM |
...
| `CompletionTable` | apps/memberry | component | 3 | ✅ | MEDIUM |
| `TrainingCard` | apps/memberry | component | 4 | — | MEDIUM |
| `TrainingForm` | apps/memberry | component | 3 | ✅ | MEDIUM |
| `TrainingList` | apps/memberry | component | 1 | ✅ paired | MEDIUM |
| `BillingPage` | apps/memberry | component | 0 | ✅ | MEDIUM |
...
| `DashboardKpiCard` | apps/memberry | component | 7 | — | MEDIUM |
| `ModuleSummaryCard` | apps/memberry | component | 6 | — | MEDIUM |
| `ChoiceQuestion` | apps/memberry | component | 4 | — | MEDIUM |
| `NpsQuestion` | apps/memberry | component | 2 | — | MEDIUM |
| `RatingQuestion` | apps/memberry | component | 3 | — | MEDIUM |
| `TextQuestion` | apps/memberry | component | 4 | — | MEDIUM |
| `YesNoQuestion` | apps/memberry | component | 2 | — | MEDIUM |
| `BookingDetailPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `ConfirmPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `HostPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `BookingsPage` | apps/memberry | component | 0 | — | MEDIUM |
| `CertificateDetail` | apps/memberry | component | 0 | — | MEDIUM |
| `MyCertificates` | apps/memberry | component | 0 | — | MEDIUM |
| `MyCredits` | apps/memberry | component | 0 | ✅ | MEDIUM |
| `CreditLog` | apps/memberry | component | 0 | — | MEDIUM |
| `SurveyDetailPage` | apps/memberry | component | 0 | — | MEDIUM |
| `MySurveys` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `DirectoryPage` | apps/memberry | component | 0 | — | MEDIUM |
...
| `NewElection` | apps/memberry | component | 0 | — | MEDIUM |
| `OfficerEvents` | apps/memberry | component | 0 | — | MEDIUM |
...
| `InstitutionalMembershipDetailPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
...
| `ProvidersPage` | apps/memberry | component | 0 | ✅ paired | MEDIUM |
| `OfficerSurveys` | apps/memberry | component | 0 | — | MEDIUM |
| `NewSurveyPage` | apps/memberry | component | 0 | — | MEDIUM |
| `OfficerTraining` | apps/memberry | component | 0 | — | MEDIUM |
