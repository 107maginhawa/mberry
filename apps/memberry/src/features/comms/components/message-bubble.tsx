 ...
 */
export function MessageBubble({ message, isOwn, onOpenThread, reactions = [], onReact, onRemoveReaction }: MessageBubbleProps) {
  ...
  return (
    <div
      role="listitem"
      className={`group flex ${isOwn ? 'justify-end' : 'justify-start'} py-1`}
    >
      <div
