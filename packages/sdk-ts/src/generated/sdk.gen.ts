 ...
 */
export const listOfficerTerms2 = <ThrowOnError extends boolean = false>(options: Options<ListOfficerTerms2Data, ThrowOnError>) => (options.client ?? client).get<ListOfficerTerms2Responses, ListOfficerTerms2Errors, ThrowOnError>({
    responseTransformer: listOfficerTerms2ResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
