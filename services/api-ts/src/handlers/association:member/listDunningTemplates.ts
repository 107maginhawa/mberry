...
import type { ListDunningTemplatesQuery } from '@/generated/openapi/validators';
import { DunningTemplateRepository } from './repos/dunning.repo';

/**
 * listDunningTemplates
 *
 * Path: GET /association/member/dunning/templates
 * OperationId: listDunningTemplates
 */
export async function listDunningTemplates(
  ctx: ValidatedContext<never, ListDunningTemplatesQuery, never>
): Promise<Response> {
