...
- [ ] **Phase 34: Wave G1 — Stabilization** — Membership input validation, grace period bounds, election test gaps (3 plans, sequential)
- [ ] **Phase 35: Wave G2 — Training/Membership Refactors** — Credit cycle date fix, carry-over cap, license normalization, terminology (parallel)
- [ ] **Phase 36: Wave G3 — Architecture Cleanup** — Cross-context decoupling, comms module consolidation plan, TypeSpec coverage (parallel)
...
| 34. Wave G1 — Stabilization | v1.4.0 | 0/3 | Not Started | -- |
| 35. Wave G2 — Training & Membership Refactors | v1.4.0 | 0/? | Not Started | -- |
| 36. Wave G3 — Architecture Cleanup | v1.4.0 | 0/? | Not Started | -- |
